...
cmds_join = join
    ...
    .record_transcriptions-description = Rejestrować wszystkie protokoły? Użytkownicy dostaną wiadomość prywatną, gdy Scripty opuści kanał. Wartość domyślna: fałsz.
