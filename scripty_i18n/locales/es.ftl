...
automod-setup-embed-complete-title = ¡Configuración de automod completado!
...
voice-connection-error-msg-no-reconnect = Tuve un problema ({ $reason }) y me desconecté del chat de voz.
