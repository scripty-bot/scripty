...
join-success-help-title = Need hewp, UwU?
join-success-help-description = You can eithew join the suppowt sewvew at { $supportServerInvite }, or DM the bot. UvU.
join-success-footer-free-trial-upsell = T-this sewvew is ewigibwle fow a fwee twial of Premium! ^.^ DM the bot to wequest one.
join-success-premium = Y-you can check owt this sewvew’s Premium status with ‘ /premium info ’.
join-forum-thread-content-auto = An awtomatic twanscwipt was stawted { $timestamp }.
join-success-description = S-successfully joined { $voiceTargetMention }, and sending twanscwiption output to { $outputChannelMention }.
